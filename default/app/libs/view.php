...
class View extends KumbiaView {
    ...
    public static function process($moduleName, $processName=null, $setTitle=true) {
        return self::partial('process', false, array('modulo'=>$moduleName, 'proceso'=>$processName));
    }
    
    public static function processAdminLTE($moduleName, $processName=null, $setTitle=true, $page_area=NULL) {
        return self::partial('AdminLTE/process', false, array('modulo'=>$moduleName, 'proceso'=>$processName, 'titulo'=>$setTitle));
    }
    /**
