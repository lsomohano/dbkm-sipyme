...
class levantamiento extends ActiveRecord {
     ...
     */
    public function getProyectos($proyecto_id) {
        $proyecto_id     = Filter::get($proyecto_id,'numeric');
        $columnas   = 'levantamiento.*, proyecto.nombrecorto';
        $join       = 'INNER JOIN proyecto ON proyecto.id = levantamiento.proyecto_id ';  
