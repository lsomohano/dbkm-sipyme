        ...
        if(self::$_main) {
            ...
            foreach(self::$_main as $main) {         
                ...
                if(!(self::$_entorno == Menu::BACKEND)) {
                    ...
                    $text ='<i class="fa '.$main->icono.'"></i>';
                    $text.='<span>'.$main->menu.'</span>';
                    $text.='<i class="fa fa-angle-left pull-right"></i>';
                    $html.= DwHtml::link('#', $text, NULL, NULL, FALSE);                     
                        $html.= '<ul class="treeview-menu">';
                        foreach(self::$_items[$main->menu] as $item) {
                            $active = ($item->url==$route) ? 'active' : null;
                            $html.= '<li class="'.$active.'">'.DwHtml::link($item->url, $item->menu, NULL, 'fa fa-circle-o', FALSE).'</li>';                        
                        }
                        $html.= '</ul>';
                    $html.= '</li>';
                }
